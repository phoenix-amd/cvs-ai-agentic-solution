...
1. [Architecture Decision: Pure Agent Layer](#architecture-decision-pure-agent-layer)
2. [How to Create a Claude Code Skill](#how-to-create-a-claude-code-skill)
3. [Version Update Lifecycle](#version-update-lifecycle)
4. [Feature Comparison: Agent Layer vs Fork](#feature-comparison-agent-layer-vs-fork)
